...
const sampleIgnored: TraceCoverageFile[] = [
...
const meta: Meta<typeof TraceCoveragePanel> = {
  ...
  argTypes: {
    ...
    onAddIgnorePattern: { action: 'addIgnorePattern' },
    onRemoveIgnorePattern: { action: 'removeIgnorePattern' },
